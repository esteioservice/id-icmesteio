...
<script>
  ...
  '<p>A sua privacidade é importante para nós. É política do ICM Esteio respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <strong>ICM Esteio</strong>, e outros sites que possuímos e operamos.</p>' +
  ...
  '<p>O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de aviso de Privacidade e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contacto connosco.</p>' +
  '<h2>Política de Cookies ICM Esteio</h2>' +
  ...
  '<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o ICM Esteio oferece no site e com caráter enunciativo, mas não limitativo:</p>' +
  '<ul>' +
  ...
  '  <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do ICM Esteio, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>' +
  '</ul>' +
