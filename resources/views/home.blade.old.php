        ...
        <div class="col-md-6 mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <label><b>Email do Grupo: </b>{{auth()->user()->email_institucional}}</label>
                    </div>
                    <div>
                    ...
                    <div class="mt-2 text-right">
                        ...
                        <a href="{{route('usuario.index')}}"><button type="button" class="btn btn-primary">Aprovar Usuários</button></a>
                        @endif
                ...
                <div class="card-body">
                    <div class="row">
                        @foreach($equipes as $equipe)
                            <div class="col-md-12">{{$equipe->equipe}}</div>
                        @endforeach
                    </div>
                    <div class="mt-2 text-right">
                        @if(in_array(auth()->user()->perfil,[1,2]))
